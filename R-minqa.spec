...
Version  : 1.2.7
Release  : 95
URL      : https://cran.r-project.org/src/contrib/minqa_1.2.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/minqa_1.2.7.tar.gz
...
%setup -q -n minqa
pushd ..
cp -a minqa buildavx2
popd
pushd ..
cp -a minqa buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716400861
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/minqa/libs/minqa.so
/V4/usr/lib64/R/library/minqa/libs/minqa.so
